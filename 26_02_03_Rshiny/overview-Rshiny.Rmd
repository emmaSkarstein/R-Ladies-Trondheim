...
Classic R plotting aesthetics - but interactive, so users can explore data for themselves!
...
- Create a [card](https://pkgs.rstudio.com/bslib/articles/cards/) in the viruses page for each different target in the data set (advanced challenge do this with a function)
...
- Add a [notification](https://shiny.posit.co/r/components/display-messages/notifications/) when the wwtp is changed
